...
class TestSock:
    """ Эмулирует работу сокета для тестов функций """
    ...
    # Тут я не понял. Исходная send должна принимать два параметра, кроме, собственно, сокета (self)
    # должно быть и сообщение. Но если добавить в объявление функции ещё один параметр
    # ((self, msg)), то не работает.
    def send(self):
